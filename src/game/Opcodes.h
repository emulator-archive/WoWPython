...
enum Opcodes { 
    ...
    MSG_LIST_STABLED_PETS 					= 0x026d,
    CMSG_STABLE_PET 						= 0x026e,
    CMSG_UNSTABLE_PET 						= 0x026f,
    CMSG_BUY_STABLE_SLOT 					= 0x0270,
    SMSG_STABLE_RESULT 						= 0x0271,
    CMSG_STABLE_REVIVE_PET 					= 0x0272,
    CMSG_STABLE_SWAP_PET 					= 0x0273,
    MSG_QUEST_PUSH_RESULT 					= 0x0274,
    SMSG_PLAY_MUSIC 						= 0x0275,
    SMSG_PLAY_OBJECT_SOUND 					= 0x0276,
    CMSG_REQUEST_PET_INFO 					= 0x0277,
    CMSG_FAR_SIGHT 						= 0x0278,
    SMSG_SPELLDISPELLOG 					= 0x0279,
    SMSG_DAMAGE_CALC_LOG 					= 0x027a,
    CMSG_ENABLE_DAMAGE_LOG 					= 0x027b,
    CMSG_GROUP_CHANGE_SUB_GROUP 				= 0x027c,
    SMSG_RAID_MEMBER_STATS 					= 0x027d,
    CMSG_GROUP_SWAP_SUB_GROUP 					= 0x027e,
    CMSG_RESET_FACTION_CHEAT 					= 0x027f,
    CMSG_AUTOSTORE_BANK_ITEM 					= 0x0280,
    CMSG_AUTOBANK_ITEM 						= 0x0281,
    MSG_QUERY_NEXT_MAIL_TIME 					= 0x0282,
    SMSG_RECEIVED_MAIL 						= 0x0283,
    SMSG_RAID_GROUP_ONLY 					= 0x0284,
    CMSG_SET_DURABILITY_CHEAT 					= 0x0285,
    CMSG_SET_PVP_TITLE 						= 0x0286,
    CMSG_SET_PVP_RANK_CHEAT 					= 0x0287,
    CMSG_ADD_PVP_MEDAL_CHEAT 					= 0x0288,
    CMSG_DEL_PVP_MEDAL_CHEAT 					= 0x0289,
    SMSG_PVP_CREDIT 						= 0x028a,
    SMSG_AUCTION_REMOVED_NOTIFICATION 				= 0x028b,
    CMSG_GROUP_RAID_CONVERT 					= 0x028c,
    CMSG_GROUP_ASSISTANT_LEADER 				= 0x028d,
    CMSG_BUYBACK_ITEM 						= 0x028e,
    SMSG_SERVER_MESSAGE 					= 0x028f,
    CMSG_GMTICKETSYSTEM_TOGGLE 					= 0x0290,
    CMSG_CANCEL_GROWTH_AURA 					= 0x0291,
    SMSG_CANCEL_AUTO_REPEAT 					= 0x0292,
    SMSG_STANDSTATE_CHANGE_ACK 					= 0x0293,
    NUM_MSG_TYPES 						= 0x0294,
};
